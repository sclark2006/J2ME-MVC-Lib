...
public final class PeopleListView extends ListView {
    ...
    private void initComponents() {
        ...
        this.addCommand(this.deleteCommand = new Command("Delete",
                Command.ITEM, 1));
        this.addCommand(this.loansCommand = new Command("Loans...",
                Command.ITEM, 2));
        this.addCommand(this.sortCommand = new Command("Sort (Age)",
                Command.SCREEN, 1));
        //this.addCommand(this.showBirthdaysCommand = new Command("Birthdays",
        //        Command.SCREEN, 2));
    ...
    public void commandAction(Command command, Displayable display) {
        ...
        if (deleteCommand.equals(command))
            controller.delete();
        if (sortCommand.equals(command))
            ((PeopleController) controller).toggleSort();
